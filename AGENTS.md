...
This file lives at the root of the [dotfiles](https://github.com/izaiasmachado/dotfiles) repo and is installed as the global agent config via `make agents`:
...
The rules below apply to **every repo** Codex/Claude touch. A repo can override or extend them with its own root `AGENTS.md` / `CLAUDE.md`.
